...
public class FollowGenerator {
    ...
    public List<Follow> generateUsersAndFollows(int userCount, int minFollowersPerUser,
                                                int maxFollowersPerUser, Sort sortOrder) throws IOException {
    ...
    public List<Follow> generateFollowsForUsers(List<User> users,
        ...
        */
        ...
        String data = null;
        try {
            File file = new File(classLoader.getResource("follows_list.txt").getFile());
        ...
        Gson gson = new Gson();
        Type type = new TypeToken<List<Follow>>(){}.getType();
        follows = gson.fromJson(data, type);
